...
nvcc ./main4.cu -lineinfo -o solution4
...
do
  ...
  echo '============================'
  nvprof --metrics gld_efficiency,gst_efficiency,shared_efficiency,atomic_replay_overhead,atomic_throughput,atomic_transactions ./solution4 $test $test
done
