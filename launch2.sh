...
nvcc ./main2.cu -lineinfo -o solution2
...
do
  ...
  echo '============================'
  nvprof --metrics gld_efficiency,gst_efficiency,shared_efficiency,atomic_replay_overhead,atomic_throughput,atomic_transactions ./solution2 $test $test
done
